  ...
  return (
    <div className="min-h-[calc(100vh-64px)] space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold">View Placement</h1>
          <p className="text-sm text-gray-500">Placement details and information.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">{placement.name}</h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-500">Role/Position</label>
                <p className="text-sm text-gray-900">{placement.role}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-500">Company</label>
                <p className="text-sm text-gray-900">{placement.company}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          {/* Student Image */}
          <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Student Image</h3>
          ...
          <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-900">{new Date(placement.created_at).toLocaleDateString()}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-500">Last Updated</label>
                <p className="text-sm text-gray-900">{new Date(placement.updated_at).toLocaleDateString()}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-500">Placement ID</label>
                <p className="text-sm text-gray-900 font-mono">{placement.id}</p>
              </div>
            </div>
          </div>
        </div>
